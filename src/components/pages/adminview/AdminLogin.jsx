    ...
    <Layout className="layout">
      ...
      <Content className="login-content">
        <Form className="login-form" layout="vertical" onFinish={handleSubmit}>
          ...
          <Form.Item>
            <Button type="primary" htmlType="submit" className="login-button" onClick={() => setAction('login')}>
              로그인
            </Button>
          </Form.Item>
          <Form.Item>
            <Button type="default" htmlType="submit" className="register-button" onClick={() => setAction('signup')}>
              계정 생성
            </Button>
          </Form.Item>
        </Form>
